...
public class UnitTest {
	...
	public void constructorLegalCase() {
		...
		assertTrue(Util.fuzzyEquals((double) legalUnit.getOrientation(), Math.PI /2));
		assertTrue(Util.fuzzyEquals(legalUnit.maxSecondaryAttribute(), legalUnit.getStamina()));
		assertTrue(Util.fuzzyEquals(legalUnit.maxSecondaryAttribute(), legalUnit.getHitpoints()));
		assertEquals(Activity.IDLE, legalUnit.getActivity());
	...
	public void nearestValidInitialWeight_LowCase(){
		assertEquals(legalUnit.lowestValidWeight(), legalUnit.nearestValidInitialWeight(20));
	}
	...
	public void nearestValidWeight_LowCase(){
		assertEquals(legalUnit.lowestValidWeight(), legalUnit.nearestValidWeight(20));
	}
	...
	public void testMaxSecondaryAttribute() {
		assertEquals(50, (int) Math.ceil(legalUnit.getWeight() * legalUnit.getToughness() / 50.0));
	}
	...
	public void setOrientation_LegalCase(){
		...
		assertTrue(Util.fuzzyEquals((Math.PI - 0.2), legalUnit.getOrientation()));
	}
	
	@Test
	public void setOrientation_IllegalCase(){
		legalUnit.setOrientation((float) (Math.PI - 5));
		assertTrue(Util.fuzzyEquals((Math.PI - 5)% (2* Math.PI), legalUnit.getOrientation()));
	}
